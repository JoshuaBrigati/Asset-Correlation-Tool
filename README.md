...
You'll be building a minimal version of our Correlations Tool — a UI that lets users visualize correlations between stocks, ETFs, and crypto assets over a given time period, including a rolling correlation chart showing how those correlations change over time. https://experts.bitwiseinvestments.com/tools/correlations is our current tool for reference. 

The backend is fully scaffolded. You focus entirely on the UI.

The goal here is not to copy the reference implementation, but to build your version of the tool. Use whatever tools, agents, llms, or libraries that help you build the best idea you can in the short time you'll have to spend on this project. 
...
This is a TypeScript Next.js project with Tailwind CSS pre-configured. You're not required or limited to the included libraries — use whatever you're most comfortable with to produce your best work. For charting, we recommend [Recharts](https://recharts.org/en-US/) or [VISX](https://airbnb.io/visx/).
